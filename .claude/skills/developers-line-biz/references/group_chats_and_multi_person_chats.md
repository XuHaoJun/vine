...
**Source:** https://developers.line.biz/en/docs/messaging-api/group-chats/index.html.md
**Section:** Messaging API

**Description:** Explains how to handle events in group and multi-person chat, including joins, leaves, and message handling.
