...
**Source:** https://developers.line.biz/en/docs/line-mini-app/develop/develop-overview/index.html.md
**Section:** LINE MINI App

**Description:** Overview of the development flow and environment setup for LINE MINI Apps.
