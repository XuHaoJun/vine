...
**Source:** https://developers.line.biz/en/docs/line-mini-app/technicalcase/grandream/index.html.md
**Section:** LINE MINI App

**Description:** Case study of a cost-efficient, flexible dev platform built with LINE MINI App tech.
