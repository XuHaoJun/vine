...
**Source:** https://developers.line.biz/en/docs/liff/versioning-policy/index.html.md
**Section:** LINE Front-end Framework (LIFF)

**Description:** Outlines LIFF versioning strategy and backward compatibility policy.
