...
**Source:** https://developers.line.biz/en/docs/messaging-api/create-flex-message-including-video/index.html.md
**Section:** Messaging API

**Description:** Describes how to embed videos in Flex Messages for richer engagement.
