...
**Source:** https://developers.line.biz/en/docs/messaging-api/mark-as-read/index.html.md
**Section:** Messaging API

**Description:** Explains how to mark a message as read programmatically in the LINE app
