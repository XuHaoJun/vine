...
**Source:** https://developers.line.biz/en/docs/line-mini-app/in-app-purchase/iap-settings/index.html.md
**Section:** LINE MINI App

**Description:** Explains how to set up the webhook URL and register in-app purchase testers.
