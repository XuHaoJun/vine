...
**Source:** https://developers.line.biz/en/docs/line-login/managing-authorized-apps/index.html.md
**Section:** LINE Login

**Description:** Covers how users and developers can view or revoke app authorizations granted via LINE Login.
