...
**Source:** https://developers.line.biz/en/docs/line-mini-app/service/line-mini-app-oa/index.html.md
**Section:** LINE MINI App

**Description:** How to use a LINE Official Account to enhance your LINE MINI App's user experience.
