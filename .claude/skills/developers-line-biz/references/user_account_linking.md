...
**Source:** https://developers.line.biz/en/docs/messaging-api/linking-accounts/index.html.md
**Section:** Messaging API

**Description:** Enables users to securely link their LINE accounts with external service accounts using a linking token.
