...
**Source:** https://developers.line.biz/en/docs/liff/minimizing-liff-browser/index.html.md
**Section:** LINE Front-end Framework (LIFF)

**Description:** Explains how to minimize the LIFF browser window from within the app.
