...
**Source:** https://developers.line.biz/en/docs/partner-docs/line-beacon/index.html.md
**Section:** Options for corporate customers

**Description:** Explains the user-side requirements for receiving LINE Beacon events, including Bluetooth activation, OS version compatibility, and consent via LINE app settings.
