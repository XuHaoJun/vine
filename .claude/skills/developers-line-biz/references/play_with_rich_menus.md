...
**Source:** https://developers.line.biz/en/docs/messaging-api/try-rich-menu/index.html.md
**Section:** Messaging API

**Description:** An interactive tool to preview and test rich menu behaviors.
