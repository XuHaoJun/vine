...
**Source:** https://developers.line.biz/en/docs/messaging-api/switch-rich-menus/index.html.md
**Section:** Messaging API

**Description:** Shows how to implement tab switching in rich menus for multi-section navigation.
