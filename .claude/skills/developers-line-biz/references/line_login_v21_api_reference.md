...
**Source:** https://developers.line.biz/en/reference/line-login/index.html.md
**Section:** LINE Login

**Description:** API reference for LINE Login v2.1, covering endpoints for authentication, token exchange, and user profile retrieval.
