...
**Source:** https://developers.line.biz/en/docs/basics/channel-access-token/index.html.md
**Section:** LINE Platform basics

**Description:** Describes how to issue and use channel access tokens for LINE API authentication.
