...
**Source:** https://developers.line.biz/en/docs/line-mini-app/discover/introduction/index.html.md
**Section:** LINE MINI App

**Description:** Overview of LINE MINI Apps and how they run inside the LINE app.
