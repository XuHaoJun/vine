...
**Source:** https://developers.line.biz/en/docs/line-mini-app/develop/performance-guidelines/index.html.md
**Section:** LINE MINI App

**Description:** Tips for optimizing performance in LINE MINI Apps.
