...
**Source:** https://developers.line.biz/en/docs/line-mini-app/develop/permanent-links/index.html.md
**Section:** LINE MINI App

**Description:** How to create permanent URLs that launch specific content in your LINE MINI App.
