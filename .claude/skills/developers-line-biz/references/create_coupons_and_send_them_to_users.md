...
**Source:** https://developers.line.biz/en/docs/messaging-api/send-coupons-to-users/index.html.md
**Section:** Messaging API

**Description:** Explains how to create coupons using the Messaging API and send them to users as messages from your LINE Official Account.
