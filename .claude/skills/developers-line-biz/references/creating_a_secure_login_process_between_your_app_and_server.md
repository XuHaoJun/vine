...
**Source:** https://developers.line.biz/en/docs/line-login/secure-login-process/index.html.md
**Section:** LINE Login

**Description:** Explains how to securely exchange ID tokens between your client and server after login.
