# Check the availability of the LINE Platform (LINE API Status)

**Source:** https://developers.line.biz/en/docs/basics/line-api-status/index.html.md
**Section:** LINE Platform basics

**Description:** Provides the current status and availability information for the LINE API and platform services.

---

# Check the availability of the LINE Platform (LINE API Status)

LY Corporation provides [LINE API Status](https://api.line-status.info/) for checking the availability and outage status of the LINE Platform.
...
Outage status is also displayed through this pop-up on the [LINE Developers site](https://developers.line.biz/).
