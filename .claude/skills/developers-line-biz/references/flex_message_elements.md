...
**Source:** https://developers.line.biz/en/docs/messaging-api/flex-message-elements/index.html.md
**Section:** Messaging API

**Description:** Explains the UI components used in Flex Messages, such as box, text, image, and button.
