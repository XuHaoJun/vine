...
**Source:** https://developers.line.biz/en/docs/messaging-api/use-loading-indicator/index.html.md
**Section:** Messaging API

**Description:** Describes how to show a loading indicator while the bot processes events or replies.
