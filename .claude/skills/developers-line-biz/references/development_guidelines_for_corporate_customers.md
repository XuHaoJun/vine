...
**Source:** https://developers.line.biz/en/docs/partner-docs/development-guidelines/index.html.md
**Section:** Options for corporate customers

**Description:** Best practices and rules for securely and effectively using the options for corporate customers API.
