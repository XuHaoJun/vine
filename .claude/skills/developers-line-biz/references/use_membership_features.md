...
**Source:** https://developers.line.biz/en/docs/messaging-api/use-membership-features/index.html.md
**Section:** Messaging API

**Description:** Explains how to implement and manage membership levels and perks.
