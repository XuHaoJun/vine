...
**Source:** https://developers.line.biz/en/docs/basics/user-profile/index.html.md
**Section:** LINE Platform basics

**Description:** Explains how to retrieve user profile information using the LINE API.
