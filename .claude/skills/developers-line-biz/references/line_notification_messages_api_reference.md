...
**Source:** https://developers.line.biz/en/reference/line-notification-messages/index.html.md
**Section:** Options for corporate customers

**Description:** API reference for sending LINE notification messages to users.
