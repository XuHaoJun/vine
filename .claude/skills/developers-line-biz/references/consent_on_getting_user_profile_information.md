...
**Source:** https://developers.line.biz/en/docs/messaging-api/user-consent/index.html.md
**Section:** Messaging API

**Description:** Details how to obtain user consent before accessing LINE profile data.
