...
**Source:** https://developers.line.biz/en/docs/line-mini-app/develop/channel-consent-simplification/index.html.md
**Section:** LINE MINI App

**Description:** Explains how the Channel consent simplification feature in LINE MINI Apps streamlines authorization by skipping the channel consent screen for the openid scope and requesting other scopes via the verification screen.
