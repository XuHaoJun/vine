...
**Source:** https://developers.line.biz/en/docs/partner-docs/module-technical-attach-channel/index.html.md
**Section:** Options for corporate customers

**Description:** How to attach a module channel to route logic externally.
