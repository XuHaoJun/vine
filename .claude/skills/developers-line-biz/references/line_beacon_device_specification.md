...
**Source:** https://developers.line.biz/en/docs/messaging-api/beacon-device-spec/index.html.md
**Section:** Messaging API

**Description:** Technical specifications for BLE beacon devices that trigger proximity events in the LINE app.
