...
**Source:** https://developers.line.biz/en/reference/partner-docs/index.html.md
**Section:** Options for corporate customers

**Description:** Entry point to documentation for APIs available only to corporate users who have submitted the required applications.
