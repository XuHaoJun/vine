...
**Source:** https://developers.line.biz/en/docs/liff/differences-between-liff-browser-and-external-browser/index.html.md
**Section:** LINE Front-end Framework (LIFF)

**Description:** Explains key behavioral differences between the LIFF browser and standard mobile browsers.
