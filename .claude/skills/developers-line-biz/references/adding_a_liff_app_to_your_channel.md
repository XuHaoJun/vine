...
**Source:** https://developers.line.biz/en/docs/liff/registering-liff-apps/index.html.md
**Section:** LINE Front-end Framework (LIFF)

**Description:** Instructions for linking your LIFF app to a LINE Login channel via the LINE Developers Console.
