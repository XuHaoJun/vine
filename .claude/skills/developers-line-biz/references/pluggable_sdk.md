...
**Source:** https://developers.line.biz/en/docs/liff/pluggable-sdk/index.html.md
**Section:** LINE Front-end Framework (LIFF)

**Description:** The pluggable SDK is a feature that allows you to choose which LIFF APIs to include in the LIFF SDK.
