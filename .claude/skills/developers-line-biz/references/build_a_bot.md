...
**Source:** https://developers.line.biz/en/docs/messaging-api/building-bot/index.html.md
**Section:** Messaging API

**Description:** Describes how to build a bot that can send and receive messages using the Messaging API and webhooks.
