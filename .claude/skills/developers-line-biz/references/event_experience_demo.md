...
**Source:** https://developers.line.biz/en/docs/line-mini-app/demo/mixwayapi-demo/index.html.md
**Section:** LINE MINI App

**Description:** Demo integrating ticketing, routing (mixway API), and entry into a single LINE MINI App.
