...
**Source:** https://developers.line.biz/en/docs/partner-docs/notice/index.html.md
**Section:** Options for corporate customers

**Description:** Important notices and updates for corporate users of the LINE Platform.
