...
**Source:** https://developers.line.biz/en/docs/messaging-api/development-guidelines/index.html.md
**Section:** Messaging API

**Description:** Official guidelines for using the Messaging API, including rate limits and error handling.
