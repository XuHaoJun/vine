...
**Source:** https://developers.line.biz/en/docs/partner-docs/mark-as-read/index.html.md
**Section:** Options for corporate customers

**Description:** Explains how to mark a message as read programmatically in the LINE app using the old Mark as Read API.
