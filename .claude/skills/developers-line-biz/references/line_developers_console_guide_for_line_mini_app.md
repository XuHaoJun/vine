...
**Source:** https://developers.line.biz/en/docs/line-mini-app/discover/console-guide/index.html.md
**Section:** LINE MINI App

**Description:** Instructions for managing LINE MINI Apps via the LINE Developers Console.
