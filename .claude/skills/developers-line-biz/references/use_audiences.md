...
**Source:** https://developers.line.biz/en/docs/messaging-api/using-audience/index.html.md
**Section:** Messaging API

**Description:** Explains how to create, upload, and target audiences for narrowcast messages.
