...
**Source:** https://developers.line.biz/en/docs/partner-docs/line-notification-messages/flow-when-receiving-message/index.html.md
**Section:** Options for corporate customers

**Description:** Explains the user experience and technical flow when a message is received.
