...
**Source:** https://developers.line.biz/en/docs/line-mini-app/develop/external-browser/index.html.md
**Section:** LINE MINI App

**Description:** Instructions for launching LINE MINI Apps outside of the LINE app.
