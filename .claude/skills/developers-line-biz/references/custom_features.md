...
**Source:** https://developers.line.biz/en/docs/line-mini-app/discover/custom-features/index.html.md
**Section:** LINE MINI App

**Description:** Explains how developers can extend LINE MINI Apps with custom features.
