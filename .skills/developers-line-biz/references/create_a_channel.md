...
**Source:** https://developers.line.biz/en/docs/liff/getting-started/index.html.md
**Section:** LINE Front-end Framework (LIFF)

**Description:** Guide to setting up a LINE Login channel to deploy and test your LIFF app.
