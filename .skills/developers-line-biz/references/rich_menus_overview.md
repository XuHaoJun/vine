...
**Source:** https://developers.line.biz/en/docs/messaging-api/rich-menus-overview/index.html.md
**Section:** Messaging API

**Description:** Introduction to rich menus and how they enhance user experience.
