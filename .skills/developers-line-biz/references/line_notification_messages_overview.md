...
**Source:** https://developers.line.biz/en/docs/partner-docs/line-notification-messages/overview/index.html.md
**Section:** Options for corporate customers

**Description:** Overview of LINE notification messages, which allow sending messages to users by phone number.
