...
**Source:** https://developers.line.biz/en/docs/line-login/verify-id-token/index.html.md
**Section:** LINE Login

**Description:** Explains how to decode and validate ID tokens to extract user profile data.
