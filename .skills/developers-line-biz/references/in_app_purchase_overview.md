...
**Source:** https://developers.line.biz/en/docs/line-mini-app/in-app-purchase/overview/index.html.md
**Section:** LINE MINI App

**Description:** Introduction to the in-app purchase feature of LINE MINI Apps.
