...
**Source:** https://developers.line.biz/en/docs/messaging-api/use-per-user-rich-menus/index.html.md
**Section:** Messaging API

**Description:** Explains how to assign personalized rich menus to individual users.
