...
**Source:** https://developers.line.biz/en/docs/liff/overview/index.html.md
**Section:** LINE Front-end Framework (LIFF)

**Description:** Introduction to LIFF and how web apps run on the LIFF browser inside the LINE app.
