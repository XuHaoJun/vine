...
**Source:** https://developers.line.biz/en/docs/line-mini-app/technicalcase/classmethod/index.html.md
**Section:** LINE MINI App

**Description:** Case study of a mobile ordering service built with LINE MINI Apps.
