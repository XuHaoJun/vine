...
**Source:** https://developers.line.biz/en/docs/messaging-api/using-flex-message-simulator/index.html.md
**Section:** Messaging API

**Description:** A tutorial for testing and previewing Flex Messages with the simulator.
