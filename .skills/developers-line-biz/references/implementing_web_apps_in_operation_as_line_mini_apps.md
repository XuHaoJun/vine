...
**Source:** https://developers.line.biz/en/docs/line-mini-app/develop/web-to-mini-app/index.html.md
**Section:** LINE MINI App

**Description:** How to adapt existing web apps for use as LINE MINI Apps with minimal changes.
