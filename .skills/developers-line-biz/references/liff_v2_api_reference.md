...
**Source:** https://developers.line.biz/en/reference/liff/index.html.md
**Section:** LINE Front-end Framework (LIFF)

**Description:** API reference detailing the methods and properties available in the LIFF SDK.
