...
**Source:** https://developers.line.biz/en/docs/line-login/using-line-url-scheme/index.html.md
**Section:** LINE Login

**Description:** Demonstrates how to launch LINE actions such as opening chats or apps using custom URL schemes.
