...
**Source:** https://developers.line.biz/en/docs/line-mini-app/demo/reservation-demo/index.html.md
**Section:** LINE MINI App

**Description:** Demo of store reservations (e.g., salons/restaurants) with reminder notifications via LINE messages.
