...
**Source:** https://developers.line.biz/en/docs/messaging-api/pricing/index.html.md
**Section:** Messaging API

**Description:** Lists free and paid plans, message quotas, and additional fees for using the Messaging API.
