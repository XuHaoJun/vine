...
**Source:** https://developers.line.biz/en/docs/messaging-api/sending-messages/index.html.md
**Section:** Messaging API

**Description:** Describes how to send messages using the Messaging API.
