...
**Source:** https://developers.line.biz/en/docs/messaging-api/flex-message-layout/index.html.md
**Section:** Messaging API

**Description:** Layout rules and best practices for designing responsive Flex Messages.
