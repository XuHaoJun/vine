...
**Source:** https://developers.line.biz/en/docs/messaging-api/using-rich-menus/index.html.md
**Section:** Messaging API

**Description:** Describes how to configure and link rich menus to LINE Official Accounts.
