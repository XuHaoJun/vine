...
**Source:** https://developers.line.biz/en/docs/partner-docs/mission-stickers/index.html.md
**Section:** Options for corporate customers

**Description:** Guide to using the Mission Stickers API.
...
For more information on the API specifications, see [Mission Sticker API](https://developers.line.biz/en/reference/partner-docs/#mission-stickers) in the options for corporate customers API reference.
