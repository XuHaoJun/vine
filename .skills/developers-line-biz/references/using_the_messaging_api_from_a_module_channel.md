...
**Source:** https://developers.line.biz/en/docs/partner-docs/module-technical-using-messaging-api/index.html.md
**Section:** Options for corporate customers

**Description:** Explains how modules can send Messaging API requests on behalf of the bot.
