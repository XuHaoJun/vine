...
**Source:** https://developers.line.biz/en/docs/partner-docs/line-notification-messages/template/index.html.md
**Section:** Options for corporate customers

**Description:** Describes the format and structure of templates used when sending LINE notification messages (template).
