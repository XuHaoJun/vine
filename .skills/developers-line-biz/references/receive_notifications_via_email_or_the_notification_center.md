...
**Source:** https://developers.line.biz/en/docs/line-developers-console/notification/index.html.md
**Section:** LINE Developers Console

**Description:** Instructions for setting up alerts via email or the notification center.
