...
**Source:** https://developers.line.biz/en/docs/messaging-api/actions/index.html.md
**Section:** Messaging API

**Description:** Describes interactive actions like postback, URI, message, and camera.
