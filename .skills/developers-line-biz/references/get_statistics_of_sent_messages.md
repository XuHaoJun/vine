...
**Source:** https://developers.line.biz/en/docs/messaging-api/unit-based-statistics-aggregation/index.html.md
**Section:** Messaging API

**Description:** Explains how to access usage statistics for sent messages.
