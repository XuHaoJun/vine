...
**Source:** https://developers.line.biz/en/docs/liff/using-user-profile/index.html.md
**Section:** LINE Front-end Framework (LIFF)

**Description:** How to securely access and use LINE user profile data in your LIFF app and back-end.
