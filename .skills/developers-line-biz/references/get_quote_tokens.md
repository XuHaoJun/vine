...
**Source:** https://developers.line.biz/en/docs/messaging-api/get-quote-tokens/index.html.md
**Section:** Messaging API

**Description:** Covers how to retrieve and use quote tokens to reply to specific messages.
