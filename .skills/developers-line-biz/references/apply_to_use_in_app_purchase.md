...
**Source:** https://developers.line.biz/en/docs/line-mini-app/in-app-purchase/request-iap-review/index.html.md
**Section:** LINE MINI App

**Description:** Explains how to apply for and set up the in-app purchase feature.
