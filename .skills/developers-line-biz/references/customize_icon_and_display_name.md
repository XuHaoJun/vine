...
**Source:** https://developers.line.biz/en/docs/messaging-api/icon-nickname-switch/index.html.md
**Section:** Messaging API

**Description:** Allows customizing the bot's icon and display name per message for personalization.
