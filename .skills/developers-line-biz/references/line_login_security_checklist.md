...
**Source:** https://developers.line.biz/en/docs/line-login/security-checklist/index.html.md
**Section:** LINE Login

**Description:** A checklist of security best practices to ensure safe implementation of LINE Login.
