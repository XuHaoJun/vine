...
**Source:** https://developers.line.biz/en/reference/line-mini-app/index.html.md
**Section:** LINE MINI App

**Description:** API reference for LINE MINI Apps, covering endpoints and parameters.
