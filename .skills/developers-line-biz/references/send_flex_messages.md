...
**Source:** https://developers.line.biz/en/docs/messaging-api/using-flex-messages/index.html.md
**Section:** Messaging API

**Description:** How to send rich, customizable message layouts using Flex Messages.
