...
**Source:** https://developers.line.biz/en/docs/line-mini-app/discover/builtin-features/index.html.md
**Section:** LINE MINI App

**Description:** Lists features available natively within LINE MINI Apps.
