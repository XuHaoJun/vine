...
**Source:** https://developers.line.biz/en/docs/messaging-api/secure-message-sample/index.html.md
**Section:** Messaging API

**Description:** Example code and data for creating encrypted, secure messages.
