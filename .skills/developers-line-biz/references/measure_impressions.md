...
**Source:** https://developers.line.biz/en/docs/messaging-api/measure-impressions/index.html.md
**Section:** Messaging API

**Description:** Describes how the Messaging API measures message impressions and the conditions required for them to be counted.
