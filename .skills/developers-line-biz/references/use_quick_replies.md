...
**Source:** https://developers.line.biz/en/docs/messaging-api/using-quick-reply/index.html.md
**Section:** Messaging API

**Description:** Guides you through implementing quick replies in LINE bot conversations.
