...
**Source:** https://developers.line.biz/en/docs/line-mini-app/develop/configure-console/index.html.md
**Section:** LINE MINI App

**Description:** How to configure app settings via the LINE Developers Console.
