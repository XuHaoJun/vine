...
**Source:** https://developers.line.biz/en/docs/messaging-api/stop-using-messaging-api/index.html.md
**Section:** Messaging API

**Description:** Describes how to shut down your use of the Messaging API properly.
