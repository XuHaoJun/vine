...
**Source:** https://developers.line.biz/en/docs/messaging-api/getting-user-ids/index.html.md
**Section:** Messaging API

**Description:** Shows how to retrieve a user ID or group ID from webhook events and endpoints.
