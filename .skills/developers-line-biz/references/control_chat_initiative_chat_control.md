...
**Source:** https://developers.line.biz/en/docs/partner-docs/module-technical-chat-control/index.html.md
**Section:** Options for corporate customers

**Description:** Allows modules to control which bot responds when multiple modules are active.
