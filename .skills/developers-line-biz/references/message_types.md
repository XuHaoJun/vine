...
**Source:** https://developers.line.biz/en/docs/messaging-api/message-types/index.html.md
**Section:** Messaging API

**Description:** Details the various message formats supported by the Messaging API.
