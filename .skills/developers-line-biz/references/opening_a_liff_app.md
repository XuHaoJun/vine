...
**Source:** https://developers.line.biz/en/docs/liff/opening-liff-app/index.html.md
**Section:** LINE Front-end Framework (LIFF)

**Description:** Describes how users can launch a LIFF app using a URL or QR code.
