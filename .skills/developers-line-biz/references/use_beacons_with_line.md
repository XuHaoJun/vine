...
**Source:** https://developers.line.biz/en/docs/messaging-api/using-beacons/index.html.md
**Section:** Messaging API

**Description:** Describes how to trigger messages based on user proximity using BLE beacons and beacon events.
