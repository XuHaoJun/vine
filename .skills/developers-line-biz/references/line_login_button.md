...
**Source:** https://developers.line.biz/en/docs/line-login/login-button/index.html.md
**Section:** LINE Login

**Description:** Design and implementation guide for adding a LINE Login button to your app or website.
