...
**Source:** https://developers.line.biz/en/docs/partner-docs/line-notification-messages/technical-specs/index.html.md
**Section:** Options for corporate customers

**Description:** Technical documentation for the LINE notification messages API.
