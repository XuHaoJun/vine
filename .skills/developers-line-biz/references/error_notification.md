...
**Source:** https://developers.line.biz/en/docs/partner-docs/error-notification/index.html.md
**Section:** Options for corporate customers

**Description:** Guide to error codes and delivery failure notifications.
